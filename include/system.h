...
extern void download_status(void);		//32
extern void download_drv_status(void);

extern void trim_action(void);
extern void pattern_process(void);
extern void trim_io_control(UINT8 a);
#endif
//--------------------------------------------------------------------------------------
